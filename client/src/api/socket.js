...
class SocketIO {
  ...
  connect = (server_url, handshake_version, app_version) => {
    if (!server_url) {
	    global.log("socket:: connect:: abort:: server_url missing:: ", server_url);
    ...
    global.log("socket:: connect:: creating connection:: ", server_url);
  ...
  initEvents = () => {
    ...
    this.socket.on("disconnect", () => {
      global.log("socket:: event:: disconnect:: ", this.socket.id, this.socket.connected, );
      this.isConnected = this.socket.connected;
    ...
    this.socket.on('reconnect_attempt', () => {
      global.log("socket:: event:: reconnect_attempt:: ", this.socket.id, this.socket.connected, );
      // socket.io.opts.query = { token: 'fgh' }
    })


    this.socket.on("reconnecting", (attempt) => {
      global.log("socket:: event:: reconnecting:: ", attempt, this.socket.id, this.socket.connected, );
    });


    this.socket.on("reconnect", (attempt) => {
      global.log("socket:: event:: reconnect:: ", attempt, this.socket.id, this.socket.connected, );
    });
