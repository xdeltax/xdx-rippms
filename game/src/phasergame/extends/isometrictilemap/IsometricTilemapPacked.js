...
import * as bytebuffer4Tilemap from "phasergame/tools/bytebuffer4Tilemap";

//import rxdbGameStore from 'game/rxdbGameStore'; // rxdb-database
const rxdbGameStore = {}
...
export default class IsometricTilemap extends Phaser.GameObjects.Blitter { // based on blitter
  ...
  get externalData() {
    ...
    //return rxdbGameStore.basemaps ;
  } // <----------- adapter to external data (read-only)
