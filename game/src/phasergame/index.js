...
//============================================================================//
import debuglog from "debug/consolelog"; const clog = debuglog("game/index");
//============================================================================//
...
export default class PhaserGame extends Phaser.Game {
  // this = game
  constructor(react, size) {
    clog('constructor:: ', react, size, );
...
let phaserConfig = {
  parent: "phaserGameInjectID", // The DOM element-id into which this game canvas will be injected (in GameContainer.js)
