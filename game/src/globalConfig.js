...
//============================================================================//
import debuglog from "debug/consolelog"; const _clog = debuglog("");
//============================================================================//
...
global.consoleLog   = console.log.bind(console); // require('debug/bind/consoleLog.js');
...
global.dlog     = ( mainArg, ...restArgs ) => { _clog(mainArg, ...restArgs); };
