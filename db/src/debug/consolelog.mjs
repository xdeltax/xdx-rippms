...
const debuglog = (_pre) => {
  ...
  const xlog = (mainProp, ...restProps) => {
    ...
    const basename = (_pre) ? path.basename(fileURLToPath(_pre)) + " " : "";
    ...
    */
    ...
    //console.log(restProps.length)
    //if (restProps) console.log(infoString, restProps); else console.log(infoString);
