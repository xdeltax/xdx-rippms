...
import RXDBPrototype from "./RXDBPrototype.mjs";
...
export default class DBGame extends RXDBPrototype {
  constructor(collectionName) {
    super(collectionName || "game", rxdbSchema); // open/create database and create/connect collection
  }
