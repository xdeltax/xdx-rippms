...
const joi_schemaObject = Joi.object().keys({
  ...
  userid: 			joi_userid.required(), // UNIQUE
...
export default class DBUsercards extends DBPrototype {
  constructor(name) {
    super(name || "usercards");
  }
